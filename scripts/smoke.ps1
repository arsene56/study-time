...
Write-Host "10/12 创建、申请并批准自定义皮肤"
...
Write-Host "阶段 3～5 闭环通过：执行计时 → 动态重排 → 周报趋势 → 周目标结算 → 奖励审批 → 皮肤装备。" -ForegroundColor Green
